...
function master(toFork, opts) {
  var debug = require('./node_modules/forkie/node_modules/debug')('forkie:master');
  var path = require('path');
  var merge = require('deepmerge');
  var async = require('./node_modules/forkie/node_modules/async');
  ...
  var masterWorker = require('./node_modules/forkie/lib/worker.js')('master process', {
    start: function (cb) {
  ...
  function start(cb) {
    ...
    if (opts.repl) {
      repl = require('./node_modules/forkie/lib/repl.js')(masterWorker, workers, opts.repl);
